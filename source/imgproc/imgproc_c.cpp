...
HB_FUNC( CVACC )
{
  cvAcc( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? NULL : ( const CvArr* ) hb_parptr( 3 ) );
}
...
HB_FUNC( CVSQUAREACC )
{
  cvSquareAcc( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? NULL : ( const CvArr* ) hb_parptr( 3 ) );
}
...
{
  cvMultiplyAcc( ( const CvArr* ) hb_parptr( 1 ), ( const CvArr* ) hb_parptr( 2 ), ( CvArr* ) hb_parptr( 3 ), ISNIL( 4 ) ? NULL : ( const CvArr* ) hb_parptr( 4 ) );
}
...
{
  cvRunningAvg( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), hb_parnd( 3 ), ISNIL( 4 ) ? NULL : ( const CvArr* ) hb_parptr( 4 ) );
}
...
HB_FUNC( CVCOPYMAKEBORDER )
{
  ...
  cvCopyMakeBorder( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), point3, hb_parni( 4 ), ISNIL( 5 ) ? cvScalarAll(0) : scalar5 );
}
...
HB_FUNC( CVSMOOTH )
{
  cvSmooth( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? CV_GAUSSIAN : hb_parni( 3 ), ISNIL( 4 ) ? 3 : hb_parni( 4 ), ISNIL( 5 ) ? 0 : hb_parni( 5 ), ISNIL( 6 ) ? 0 : hb_parnd( 6 ), ISNIL( 7 ) ? 0 : hb_parnd( 7 ) );
}
...
HB_FUNC( CVINTEGRAL )
{
  cvIntegral( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? NULL : ( CvArr* ) hb_parptr( 3 ), ISNIL( 4 ) ? NULL : ( CvArr* ) hb_parptr( 4 ) );
}
...
HB_FUNC( CVPYRDOWN )
{
  cvPyrDown( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? CV_GAUSSIAN_5x5 : hb_parni( 3 ) );
}
...
HB_FUNC( CVPYRUP )
{
  cvPyrUp( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? CV_GAUSSIAN_5x5 : hb_parni( 3 ) );
}
...
HB_FUNC( CVSOBEL )
{
  cvSobel( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), hb_parni( 3 ), hb_parni( 4 ), ISNIL( 5 ) ? 3 : hb_parni( 5 ) );
}
...
HB_FUNC( CVLAPLACE )
{
  cvLaplace( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? 3 : hb_parni( 3 ) );
}
...
HB_FUNC( CVRESIZE )
{
  cvResize( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? CV_INTER_LINEAR : hb_parni( 3 ) );
}
...
HB_FUNC( CVWARPAFFINE )
{
  ...
  scalar5.val[ 2 ] = hb_arrayGetND( pScalar5, 3 );
  scalar5.val[ 3 ] = hb_arrayGetND( pScalar5, 4 );
  cvWarpAffine( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ( const CvMat* ) hb_parptr( 3 ), ISNIL( 4 ) ? CV_INTER_LINEAR+CV_WARP_FILL_OUTLIERS : hb_parni( 4 ), ISNIL( 5 ) ? cvScalarAll(0) : scalar5 );
}
...
HB_FUNC( CVWARPPERSPECTIVE )
{
  ...
  scalar5.val[ 2 ] = hb_arrayGetND( pScalar5, 3 );
  scalar5.val[ 3 ] = hb_arrayGetND( pScalar5, 4 );
  cvWarpPerspective( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ( const CvMat* ) hb_parptr( 3 ), ISNIL( 4 ) ? CV_INTER_LINEAR+CV_WARP_FILL_OUTLIERS : hb_parni( 4 ), ISNIL( 5 ) ? cvScalarAll(0) : scalar5 );
}
...
HB_FUNC( CVREMAP )
{
  ...
  cvRemap( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ( const CvArr* ) hb_parptr( 3 ), ( const CvArr* ) hb_parptr( 4 ), ISNIL( 5 ) ? CV_INTER_LINEAR+CV_WARP_FILL_OUTLIERS : hb_parni( 5 ), ISNIL( 6 ) ? cvScalarAll(0) : scalar6 );
}
...
{
  cvUndistort2( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ( const CvMat* ) hb_parptr( 3 ), ( const CvMat* ) hb_parptr( 4 ), ISNIL( 5 ) ? 0 : ( const CvMat* ) hb_parptr( 5 ) );
}
...
{
  cvInitUndistortMap( ( const CvMat* ) hb_parptr( 1 ), ( const CvMat* ) hb_parptr( 2 ), ( CvArr* ) hb_parptr( 3 ), ( CvArr* ) hb_parptr( 4 ) );
}
...
{
  cvInitUndistortRectifyMap( ( const CvMat* ) hb_parptr( 1 ), ( const CvMat* ) hb_parptr( 2 ), ( const CvMat* ) hb_parptr( 3 ), ( const CvMat* ) hb_parptr( 4 ), ( CvArr* ) hb_parptr( 5 ), ( CvArr* ) hb_parptr( 6 ) );
}
...
{
  cvUndistortPoints( ( const CvMat* ) hb_parptr( 1 ), ( CvMat* ) hb_parptr( 2 ), ( const CvMat* ) hb_parptr( 3 ), ( const CvMat* ) hb_parptr( 4 ), ISNIL( 5 ) ? 0 : ( const CvMat* ) hb_parptr( 5 ), ISNIL( 6 ) ? 0 : ( const CvMat* ) hb_parptr( 6 ) );
}
...
HB_FUNC( CVERODE )
{
  cvErode( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? NULL : ( IplConvKernel* ) hb_parptr( 3 ), ISNIL( 4 ) ? 1 : hb_parni( 4 ) );
}
...
HB_FUNC( CVDILATE )
{
  cvDilate( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? NULL : ( IplConvKernel* ) hb_parptr( 3 ), ISNIL( 4 ) ? 1 : hb_parni( 4 ) );
}
...
{
  cvMorphologyEx( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ( CvArr* ) hb_parptr( 3 ), ( IplConvKernel* ) hb_parptr( 4 ), hb_parni( 5 ), ISNIL( 6 ) ? 1 : hb_parni( 6 ) );
}
...
HB_FUNC( CVSAMPLELINE )
{
  ...
  point3.x = hb_arrayGetNI( pPoint3, 1 );
  point3.y = hb_arrayGetNI( pPoint3, 2 );
  hb_retni( cvSampleLine( ( const CvArr* ) hb_parptr( 1 ), point2, point3, ( void* ) hb_parptr( 4 ), ISNIL( 5 ) ? 8 : hb_parni( 5 ) ) );
}
...
{
  hb_retptr( ( CvSeq* ) cvApproxChains( ( CvSeq* ) hb_parptr( 1 ), ( CvMemStorage* ) hb_parptr( 2 ), ISNIL( 3 ) ? CV_CHAIN_APPROX_SIMPLE : hb_parni( 3 ), ISNIL( 4 ) ? 0 : hb_parnd( 4 ), ISNIL( 5 ) ? 0 : hb_parni( 5 ), ISNIL( 6 ) ? 0 : hb_parni( 6 ) ) );
}
...
{
  hb_retptr( ( CvSeq* ) cvApproxPoly( ( const void* ) hb_parptr( 1 ), hb_parni( 2 ), ( CvMemStorage* ) hb_parptr( 3 ), hb_parni( 4 ), hb_parnd( 5 ), ISNIL( 6 ) ? 0 : hb_parni( 6 ) ) );
}
...
HB_FUNC( CVARCLENGTH )
{
  ...
  hb_retnd( cvArcLength( ( const void* ) hb_parptr( 1 ), ISNIL( 2 ) ? CV_WHOLE_SEQ : slice2, ISNIL( 3 ) ? -1 : hb_parni( 3 ) ) );
}
...
{
  CvRect rect;
  rect = cvBoundingRect( ( CvArr* ) hb_parptr( 1 ), ISNIL( 2 ) ? 0 : hb_parni( 2 ) );
...
HB_FUNC( CVCONTOURAREA )
{
  ...
  slice2.start_index = hb_arrayGetNI( pSlice2, 1 );
  slice2.end_index   = hb_arrayGetNI( pSlice2, 2 );
  hb_retnd( cvContourArea( ( const CvArr* ) hb_parptr( 1 ), ISNIL( 2 ) ? CV_WHOLE_SEQ : slice2, ISNIL( 3 ) ? 0 : hb_parni( 3 ) ) );
}
...
{
  hb_retnd( cvMatchShapes( ( const void* ) hb_parptr( 1 ), ( const void* ) hb_parptr( 2 ), hb_parni( 3 ), ISNIL( 4 ) ? 0 : hb_parnd( 4 ) ) );
}
...
{
  hb_retptr( ( CvSeq* ) cvConvexHull2( ( const CvArr* ) hb_parptr( 1 ), ISNIL( 2 ) ? NULL : ( void* ) hb_parptr( 2 ), ISNIL( 3 ) ? CV_CLOCKWISE : hb_parni( 3 ), ISNIL( 4 ) ? 0 : hb_parni( 4 ) ) );
}
...
{
  hb_retptr( ( CvSeq* ) cvConvexityDefects( ( const CvArr* ) hb_parptr( 1 ), ( const CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? NULL : ( CvMemStorage* ) hb_parptr( 3 ) ) );
}
...
{
  cvCalcArrHist( ( CvArr** ) hb_parptr( 1 ), ( CvHistogram* ) hb_parptr( 2 ), ISNIL( 3 ) ? 0 : hb_parni( 3 ), ISNIL( 4 ) ? NULL : ( const CvArr* ) hb_parptr( 4 ) );
}
...
HB_FUNC( CVCALCHIST )
{
  cvCalcHist( ( IplImage** ) hb_parptr( 1 ), ( CvHistogram* ) hb_parptr( 2 ), ISNIL( 3 ) ? 0 : hb_parni( 3 ), ISNIL( 4 ) ? NULL : ( const CvArr* ) hb_parptr( 4 ) );
}
...
{
  cvCalcProbDensity( ( const CvHistogram* ) hb_parptr( 1 ), ( const CvHistogram* ) hb_parptr( 2 ), ( CvHistogram* ) hb_parptr( 3 ), ISNIL( 4 ) ? 255 : hb_parnd( 4 ) );
}
...
{
  cvAdaptiveThreshold( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), hb_parnd( 3 ), ISNIL( 4 ) ? CV_ADAPTIVE_THRESH_MEAN_C : hb_parni( 4 ), ISNIL( 5 ) ? CV_THRESH_BINARY : hb_parni( 5 ), ISNIL( 6 ) ? 3 : hb_parni( 6 ), ISNIL( 7 ) ? 5 : hb_parnd( 7 ) );
}
...
HB_FUNC( CVCANNY )
{
  cvCanny( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), hb_parnd( 3 ), hb_parnd( 4 ), ISNIL( 5 ) ? 3 : hb_parni( 5 ) );
}
...
{
  cvPreCornerDetect( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), ISNIL( 3 ) ? 3 : hb_parni( 3 ) );
}
...
{
  cvCornerEigenValsAndVecs( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), hb_parni( 3 ), ISNIL( 4 ) ? 3 : hb_parni( 4 ) );
}
...
{
  cvCornerMinEigenVal( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), hb_parni( 3 ), ISNIL( 4 ) ? 3 : hb_parni( 4 ) );
}
...
{
  cvCornerHarris( ( const CvArr* ) hb_parptr( 1 ), ( CvArr* ) hb_parptr( 2 ), hb_parni( 3 ), ISNIL( 4 ) ? 3 : hb_parni( 4 ), ISNIL( 5 ) ? 0.04 : hb_parnd( 5 ) );
}
...
{
  hb_retptr( ( CvSeq* ) cvHoughLines2( ( CvArr* ) hb_parptr( 1 ), ( void* ) hb_parptr( 2 ), hb_parni( 3 ), hb_parnd( 4 ), hb_parnd( 5 ), hb_parni( 6 ), ISNIL( 7 ) ? 0 : hb_parnd( 7 ), ISNIL( 8 ) ? 0 : hb_parnd( 8 ) ) );
}
...
{
  hb_retptr( ( CvSeq* ) cvHoughCircles( ( CvArr* ) hb_parptr( 1 ), ( void* ) hb_parptr( 2 ), hb_parni( 3 ), hb_parnd( 4 ), hb_parnd( 5 ), ISNIL( 6 ) ? 100 : hb_parnd( 6 ), ISNIL( 7 ) ? 100 : hb_parnd( 7 ), ISNIL( 8 ) ? 0 : hb_parni( 8 ), ISNIL( 9 ) ? 0 : hb_parni( 9 ) ) );
}
